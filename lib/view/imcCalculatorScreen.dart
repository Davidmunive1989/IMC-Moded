            ...
            SizedBox(
              height: 1.w,
                ...
                Container(
                    ...
                    decoration: BoxDecoration(),
                    alignment: Alignment.center,
                    child: Text('Su IMC es', textAlign: TextAlign.center,
              ...
              children: [
                ...
                Container(
                    ...
                    decoration: BoxDecoration(border: Border.all(color: Colors.black,),
                        borderRadius: BorderRadius.circular(10)),
                    alignment: Alignment.center,
                    child: Text(imc.toStringAsFixed(1), textAlign: TextAlign.center,
                      style: const TextStyle(
                ...
                Container(
                  ...
                  height: 15.w,
                  alignment: Alignment.center,
                  child: Text (diag, textAlign: TextAlign.center, style: const TextStyle(
                      fontSize: 28, fontWeight: FontWeight.bold,
                  ),
                  ),
                ),
